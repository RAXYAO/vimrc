...
" Vim UI {
    if !exists('g:override_spf13_plug') && filereadable(expand("$VIM/vimfiles/plugged/vim-colors-solarized/colors/solarized.vim"))
...
" Misc {
if isdirectory(expand("$VIM/vimfiles/plugged/nerdtree"))
    let g:NERDShutUp=1
endif
if isdirectory(expand("$VIM/vimfiles/plugged/matchit.zip"))
...
if isdirectory(expand("$VIM/vimfiles/plugged/nerdtree-git-plugin"))
...
" AsyncRun {
if isdirectory(expand('$VIM/vimfiles/plugged/asyncrun.vim'))
...
" ctrlp {
if isdirectory(expand("$VIM/vimfiles/plugged/ctrlp.vim/"))
    ...
    if isdirectory(expand("$VIM/vimfiles/plugged/ctrlp-funky/"))
        " CtrlP extensions
...
" TagBar {
if isdirectory(expand("$VIM/vimfiles/plugged/tagbar/"))
...
" Fugitive {
if isdirectory(expand("$VIM/vimfiles/plugged/vim-fugitive/"))
...
" UndoTree {
if isdirectory(expand("$VIM/vimfiles/plugged/undotree/"))
...
if isdirectory(expand("$VIM/vimfiles/plugged/vim-airline-themes/"))
